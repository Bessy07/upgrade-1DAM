...
//javac -d bin EjercicioExamen\SimulacroExamen.java
//Compilar en terminal y luego ya ejecutar normalmente
...
public class SimulacroExamen {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            String nombre = scanner.nextLine().trim();  // Leer nombre del usuario
        ...
        System.out.println("Indique un nombre a buscar: ");
